  ...
  return (
    <>
      ...
      <div className="About">
        ...
        <div className="containerAbout">
          <h3 className="titulo"><br /><b>MISIÓN</b><br /><br /></h3>
          <h5 className="historiaa">
            En Learning Time, nos dedicamos apasionadamente a empoderar a las personas a través de la educación para la vida, brindando herramientas y recursos accesibles que promuevan el desarrollo integral y sostenible de individuos en todas las etapas de su trayectoria. Nuestra misión se centra en cultivar habilidades prácticas, fomentar el bienestar emocional y nutrir el crecimiento personal, facilitando así el camino hacia una vida plena y significativa.
            <br />
            <br />
            ...
            ✓ Énfasis en el Empoderamiento Personal
          </h5>
        </div>
      ...
      <div className="About">
        <div className="containerAbout">
          <h3 className="titulo"><br /><b> <br />VISIÓN</b><br /><br /></h3>
          <h5 className="historiaaa">
            En Learning Time, visualizamos un mundo donde cada individuo, independientemente de su origen, edad o contexto, tiene acceso a una educación para la vida que no solo enriquece sus habilidades prácticas, sino que también nutre su bienestar emocional y promueve su crecimiento personal. <br /> <br />Imaginamos comunidades globales interconectadas, donde el conocimiento es una herramienta poderosa para la transformación positiva, inspirando a las personas a vivir vidas significativas y contribuir activamente al bienestar colectivo. Aspiramos a ser líderes en la revolución educativa, guiando a las generaciones presentes y futuras hacia un futuro sostenible, equitativo y lleno de posibilidades para todos.
          </h5>
        </div>
        <div className="img">
