        ...
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body">
              ...
              <br></br>✔ Importancia de la mentalidad positiva en la salud mental y el bienestar.
              <br></br>✔ Diferencias entre mentalidad positiva y mentalidad negativa.
              <br></br>✔ Impacto de la mentalidad positiva en la toma de decisiones y la resiliencia.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body">
              ✔ Identificación de patrones de pensamiento negativo y cómo cambiarlos.
              <br></br>✔ Establecimiento de metas realistas y motivadoras.
              <br></br>✔ Prácticas diarias para fomentar la positividad.
              <br></br>✔ Creación de un entorno propicio para mantener una mentalidad positiva.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          >
            ...
            ✔ Estrategias para manejar el estrés y la presión.
              ...
              <br></br>✔ Técnicas de mindfulness y meditación para promover la tranquilidad mental.
            </div>
          </div>
        </div>
      </div>
