      ...
      <section className="containerCourses">
        <section className="my-component">
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              ...
              prácticas para gestionar de manera efectiva tus recursos
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              ...
              significativas. Cubre temas como el ahorro, la inversión, la
              reducción de deudas y la creación de un plan financiero
              personalizado.
            </p>
        ...
        <section className="my-component">
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              La psicología positiva se centra en el estudio de aspectos
              positivos de la experiencia humana, como la felicidad, la gratitud
              y el florecimiento personal. Este curso explora las teorías y
              prácticas de la psicología positiva para promover el bienestar
              mental.
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              ...
              se ha popularizado y adaptado en contextos secularizados y
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              Este curso se enfoca en estrategias prácticas para manejar el
              estrés y mejorar el bienestar emocional. Examina técnicas de
              afrontamiento, manejo del tiempo y prácticas que fomentan la
              resiliencia en situaciones estresantes.
            </p>
        ...
        <section className="my-component">
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              Este curso se centra en el fitness funcional, que implica
              ejercicios diseñados para mejorar la capacidad del cuerpo para
              realizar actividades diarias de manera más efectiva. Puede incluir
              entrenamiento con peso corporal, ejercicios con equipamiento
              funcional y la incorporación de movimientos que imitan acciones
              cotidianas.
            </p>
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              La psicología positiva se centra en el estudio de la experiencia
              humana, como la felicidad, la gratitud y el florecimiento
              personal. Este curso explora las teorías y prácticas de la
              psicología positiva para promover el bienestar mental.
            </p>
          ...
          <div className="course-info">
            ...
            <p className="parrafoCurso">
              ...
              conocido como calistenia. Aprenderás técnicas para desarrollar
              fuerza, resistencia y flexibilidad utilizando principalmente tu
              propio peso como resistencia. El curso puede incluir ejercicios
